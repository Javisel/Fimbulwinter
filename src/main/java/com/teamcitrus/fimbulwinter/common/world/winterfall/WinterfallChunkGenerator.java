...
public class WinterfallChunkGenerator extends NoiseChunkGenerator<WinterfallGenSettings> {
    ...
    public WinterfallChunkGenerator(IWorld worldIn, BiomeProvider provider, WinterfallGenSettings settingsIn) {
