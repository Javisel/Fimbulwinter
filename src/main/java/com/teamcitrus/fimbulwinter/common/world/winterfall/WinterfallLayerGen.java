...
import com.teamcitrus.fimbulwinter.common.world.winterfall.layer.FWMixRiverLayer;
import com.teamcitrus.fimbulwinter.common.world.winterfall.layer.FWRiverLayer;
...
public class WinterfallLayerGen {
    ...
    public static <T extends IArea, C extends IExtendedNoiseRandom<T>> ImmutableList<IAreaFactory<T>> buildOverworldProcedure(WorldType worldTypeIn, OverworldGenSettings settings, LongFunction<C> contextFactory) {
        ...
        lvt_7_1_ = FWRiverLayer.INSTANCE.apply((IExtendedNoiseRandom)contextFactory.apply(1L), lvt_7_1_);
        ...
        lvt_8_1_ = FWMixRiverLayer.INSTANCE.apply((IExtendedNoiseRandom)contextFactory.apply(100L), lvt_8_1_, lvt_7_1_);
    ...
    public static boolean isOcean(int biomeIn) {
        return  biomeIn == COLD_OCEAN || biomeIn == FROZEN_OCEAN  || biomeIn == DEEP_COLD_OCEAN || biomeIn == DEEP_FROZEN_OCEAN;
    }

    public static boolean isShallowOcean(int biomeIn) {
        return biomeIn == COLD_OCEAN || biomeIn == FROZEN_OCEAN;
    }
        }