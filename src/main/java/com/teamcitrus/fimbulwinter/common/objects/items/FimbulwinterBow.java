...
public abstract class FimbulwinterBow  extends BowItem {


    public FimbulwinterBow(String name, Properties builder) {
        super(builder);
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        abstractarrowentity.getCapability(ArrowDataProvider.Arrow_DATA_CAPABILITY,null).orElseThrow(NullPointerException::new).setBow(stack);
    ...
    public void onArrowHitEntity(AbstractArrowEntity arrow, Entity enity) {
