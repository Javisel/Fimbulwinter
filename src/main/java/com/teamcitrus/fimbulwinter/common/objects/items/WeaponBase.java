...
import static com.teamcitrus.fimbulwinter.main.Fimbulwinter.fimbulwinterItemGroup;

public class WeaponBase extends TieredItem {
    private final float attackDamage;
    private final float attackSpeed;

    public WeaponBase(String name, IItemTier tier, float attackDamageIn, float attackSpeedIn, Item.Properties builder) {
        super(tier, builder.group(fimbulwinterItemGroup));
