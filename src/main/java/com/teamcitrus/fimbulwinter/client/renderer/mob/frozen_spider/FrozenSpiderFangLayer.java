...
@OnlyIn(Dist.CLIENT)
public class FrozenSpiderFangLayer<T extends FrozenSpider, M extends SpiderModel<T>> extends LayerRenderer<T, M> {
    private static final ResourceLocation ABDOMEN = new ResourceLocation(Fimbulwinter.MODID,"textures/entity/frozen_spider/frozen_spider_fangs.png");


    public FrozenSpiderFangLayer(IEntityRenderer<T, M> p_i50921_1_) {
        super(p_i50921_1_);
    ...
    public void render(T entityIn, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
        ...
        if (entityIn.getChargePercentage()==1) {
